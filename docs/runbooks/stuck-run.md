...
PYTHONPATH=backend/src uv run celery -A stock_platform.workers.celery_app:celery_app worker --pool=solo --concurrency=1 --queues=control,ingestion-low,research-ingestion,stream-events,celery --loglevel=INFO
